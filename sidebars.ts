  ...
  tutorialSidebar: [
    'intro',
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Starlight NRP Bot',
          collapsible: true,
          collapsed: false,
          items: [
            'projects/starlight-nrp-bot/intro',
            'projects/starlight-nrp-bot/user-guide',
            'projects/starlight-nrp-bot/developer-guide',
            'projects/starlight-nrp-bot/command-reference',
            'projects/starlight-nrp-bot/troubleshooting',
          ],
        },
      ],
    },
